...
//        menu.getButtons().add(button2);
		...
		if (servletRequestAttributes != null) {
			...
			String url = WxMpConfiguration.getMpServices().get(appid).oauth2buildAuthorizationUrl(String.format("%s://%s/wx/redirect/%s/greet", requestURL.getProtocol(), requestURL.getHost(), appid), WxConsts.OAuth2Scope.SNSAPI_USERINFO, null);
			button34.setUrl(url);
		}
